...
load('datasets/unadjusted_models_list.rda')
load('datasets/adjusted_models_list.rda')
library(dplyr)
library(purrr)
```
...
```{r adding-more-details-to-each-model-item-in-a-list-NormalExercise, exercise=TRUE, exercise.setup='adding-more-details-to-each-model-item-in-a-list-NormalExercise-setup'}
...
```{r adding-more-details-to-each-model-item-in-a-list-NormalExercise-hint-2, eval=FALSE}
# Add predictor and model type to each list item
...
```{r adding-more-details-to-each-model-item-in-a-list-NormalExercise-check, eval=FALSE}
"Nice!"
```
...
```{r plotting-model-estimate-and-uncertainty-NormalExercise, exercise=TRUE, exercise.setup='plotting-model-estimate-and-uncertainty-NormalExercise-setup'}
...
```{r plotting-model-estimate-and-uncertainty-NormalExercise-hint-2, eval=FALSE}
# Keep only unadjusted models
unadjusted_results <- all_models %>% 
...
```{r plotting-model-estimate-and-uncertainty-NormalExercise-check, eval=FALSE}
"Great!"
```
...
```{r visualize-unadjusted-and-adjusted-model-results-NormalExercise, exercise=TRUE, exercise.setup='visualize-unadjusted-and-adjusted-model-results-NormalExercise-setup'}
...
```{r present-the-basic-characteristics-of-the-cohort-NormalExercise, exercise=TRUE, exercise.setup='present-the-basic-characteristics-of-the-cohort-NormalExercise-setup'}
...
```{r present-the-basic-characteristics-of-the-cohort-NormalExercise-hint-2, eval=FALSE}
# Create a table of summary statistics
characteristics_table <- tidied_framingham %>% 
	# These discrete variables are numeric, but must be factors
    mutate_at(vars(followup_visit_number, got_cvd), as.factor) %>% 
...
```{r present-the-basic-characteristics-of-the-cohort-NormalExercise-check, eval=FALSE}
"Nice!"
```
...
```{r supplemental-tables-of-raw-numbers-for-results-NormalExercise, exercise=TRUE, exercise.setup='supplemental-tables-of-raw-numbers-for-results-NormalExercise-setup'}
...
```{r supplemental-tables-of-raw-numbers-for-results-NormalExercise-hint-2, eval=FALSE}
# Prepare the results for the table
table_model_results <- all_models %>% 
    # Round values of variables to 3
...
```{r supplemental-tables-of-raw-numbers-for-results-NormalExercise-check, eval=FALSE}
"Great!"
```
